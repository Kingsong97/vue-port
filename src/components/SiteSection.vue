    ...
    <section id="site">
        <div class="site__inner">
            ...
            <div class="site__wrap">
                <article v-for="(site, index) in siteText" :key="index" :class="`site__item s${index + 1}`">
                    <span class="num">{{ index + 1 }}.</span>
                    <div class="text">
                        <div v-for="text in site.text" :key="text">{{ text }}</div>
                    </div>
                    ...
                    <div class="info">
                        <span v-for="info in site.info" :key="info">{{ info }}</span>
                    </div>
                </article>
            </div>
        </div>
