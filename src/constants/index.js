...
export const skillText = [
    {
        title: '꿈을 설계하고 디자인하다',
        desc: '항상 열정과 창의성으로 도전해왔습니다. 프로젝트마다 독창적인 아이디어를 바탕으로 최상의 결과물을 만들기 위해 최선을 다해왔습니다. 나의 디자인은 단순한 작업이 아니라, 꿈을 현실로 만드는 과정입니다.'
    },
    {
        title: '창의력으로 미래를 그리다',
        desc: '끊임없는 노력과 혁신으로 미래를 그려갑니다. 모든 프로젝트에 대해 철저한 분석과 계획을 통해 최고 수준의 결과물을 제공합니다. 디자인은 나에게 예술이며, 그 예술을 통해 세상을 변화시키고자 합니다.'
    },
    {
        title: '디자인으로 세상과 소통하다',
        desc: '창의적인 아이디어와 철저한 계획으로 꿈을 현실로 만듭니다. 나는 항상 사용자 경험을 최우선으로 생각하며, 아름답고 기능적인 디자인을 통해 사람들의 삶을 개선하고자 노력합니다. 나의 작업은 단순한 디자인이 아니라, 사람들과 소통하는 방식입니다.'
    }
]
...
export const contactText = [
    ...
    {
        link2: 'mailto:webstoryboy@naver.com',
        title2: 'mail : webstoryboy@naver.com'
    }
]
